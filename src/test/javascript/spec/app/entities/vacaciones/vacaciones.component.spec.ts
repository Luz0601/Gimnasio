...
import { VacacionesComponent } from 'app/entities/vacaciones/vacaciones.component';
...
describe('Component Tests', () => {
  describe('Vacaciones Management Component', () => {
    let comp: VacacionesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VacacionesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.vacaciones[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
