...
import { NominaComponent } from 'app/entities/nomina/nomina.component';
import { NominaService } from 'app/entities/nomina/nomina.service';
import { Nomina } from 'app/shared/model/nomina.model';

describe('Component Tests', () => {
  describe('Nomina Management Component', () => {
    let comp: NominaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NominaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.nominas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
