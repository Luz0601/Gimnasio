...
describe('Service Tests', () => {
  describe('Clase Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ClaseService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Clase(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, currentDate, false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Clase', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            descripcion: 'BBBBBB',
