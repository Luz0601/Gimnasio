...
public class ClienteResourceIT {
    ...
    private static final Integer DEFAULT_CICLO = 1;
    private static final Integer UPDATED_CICLO = 2;
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.getCiclo()).isEqualTo(DEFAULT_CICLO);
    }
    ...
    public void updateCliente() throws Exception {
        ...
        assertThat(testCliente.getCiclo()).isEqualTo(UPDATED_CICLO);
    }
